...
model_path = os.path.join(this_dir, "model", "street-detection-network")
model_link = "https://github.com/steven-mi/street-detection/releases/download/v2/street-detection-network.zip"
